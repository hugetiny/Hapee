...
/// @nodoc
mixin _$Result<T> {
  int get code => throw _privateConstructorUsedError; // 响应码,0表示成功,其他值表示错误
  String get msg => throw _privateConstructorUsedError; // 错误消息,当code!=0时有值
...
abstract class _Result<T> implements Result<T> {
  ...
  @override
  int get code; // 响应码,0表示成功,其他值表示错误
  @override
  String get msg; // 错误消息,当code!=0时有值
  @override
  T? get data;
