...
abstract class $FileInfoCopyWith<$Res> {
  ...
  @useResult
  $Res call({String path, String name, int size, Request? req});
...
class _$FileInfoImpl implements _FileInfo {
  const _$FileInfoImpl(
      {this.path = "", required this.name, this.size = 0, this.req});
  ...
  @override
  String toString() {
    return 'FileInfo(path: $path, name: $name, size: $size, req: $req)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, path, name, size, req);
