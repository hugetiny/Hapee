...
translations.tr_TR = {
    'Operation Result': 'İşlem Sonucu',
    'Operation Succeeded': 'İşlem Başarılı',
    '{{name}} is connected': '{{name}} bağlandı',
    'Error': 'Hata',
    'OK': 'Tamam',
    'Confirm': 'Onayla',
    'Cancel': 'İptal et',
    ...
    'Pause': 'Duraklat',
    'Retry': 'Yeniden Dene',
    'Retry Selected Tasks': 'Seçilen Görevleri Yeniden Dene',
    'Delete': 'Sil',
    'Select All': 'Hepsini Seç',
    'Select None': 'Hiçbirini Seçme',
    'Select Invert': 'Tersini Seç',
    'Display Order': 'Görüntüleme Düzeni',
    'Copy Download Url': 'İndirme Linkini Kopyala',
    'Help': 'Yardım',
    'Search': 'Arama',
    'Default': 'Varsayılan',
    'Expand': 'Genişlet',
    ...
    'Clear Stopped Tasks': 'Durmuş Görevleri Durdur',
    'Click to view task detail': 'Detayları Görmek İçin Tıkla',
    'By File Name': 'Dosya İsmine Göre',
    'By File Size': 'Dosya Boyutuna Göre',
    'By Progress': 'İlerlemeye Göre',
    'By Remain Time': 'Kalan Süreye Göre',
    'By Download Speed': 'İndirme Hızına Göre',
    'By Upload Speed': 'Gönderme Hızına Göre',
    'Filters': 'Filtreler',
    'Download': 'İndir',
    'Upload': 'Gönder',
    ...
    'Removed': 'Kaldırıldı',
    'Finished / Stopped': 'Bitti / Durduruldu',
    'Uncompleted': 'Tamamlanmayan',
    'Click to pin': 'Pinlemek için tıkla',
    'Settings': 'Ayarla',
    'Aria2 Settings': 'Aria2 Ayarları',
    'General Settings': 'Genel Ayarlar',
    'HTTP/FTP/SFTP Settings': 'HTTP/FTP/SFTP Ayarları',
    'HTTP Settings': 'HTTP Ayarları',
    'FTP/SFTP Settings': 'FTP/SFTP Ayarları',
    'BitTorrent Settings': 'BitTorrent Ayarları',
    'Metalink Settings': 'Metalink Ayarları',
    'RPC Settings': 'RPC Ayarları',
    'Advanced Settings': 'Gelişmiş Ayarları',
    'Negibox Debug Console': 'Negibox Hata Ayıklama Konsolu',
    'Engine Status': 'Makine Durumu',
    'File Name': 'Dosya İsmi',
    'File Size': 'Dosya Boyutu',
    'Progress': 'İlerleme',
    'Share Ratio': 'Paylaşma Ratiosu',
    'Remain Time': 'Kalan',
    'Download Speed': 'İndirme Hızı',
    'Upload Speed': 'Gönderme Hızı',
    'Links': 'Linkler',
    'Torrent File': 'Torrent Dosyası',
    'Metalink File': 'Metalink Dosyası',
    'File Name:': 'Dosya Adı:',
    'Options': 'Seçenekler',
    ...
    'Files': 'Dosyalar',
    'Peers': 'Eşler',
    'Task Name': 'Görev İsmi',
    'Task Size': 'Görev Boyutu',
    'Task Status': 'Görev Durumu',
    'Error Description': 'Hata Açıklaması',
    'Health Percentage': 'Sağlık Yüzdesi',
    'Info Hash': 'Bilgi Hashi',
    'Seeders': 'Seedleyenler',
    'Connections': 'Bağlantılar',
    'Seed Creation Time': 'Seed Oluşturulma Zamanı',
    'Download Url': 'Urlyi İndir',
    'Download Dir': 'Klasörü İndir',
    'BT Tracker Servers': 'BT Tracker Sunucuları',
    'Copy': 'Kopyala',
    ...
    'Other': 'Diğer',
    'Custom': 'Özel',
    'Custom Choose File': 'Özel Dosya Seç',
    'Address': 'Adres',
    'Client': 'İstemci',
    'Status': 'Durum',
    'Speed': 'Hız',
    'local': 'Lokal',
    'No Data': 'Veri Yok',
    'No connected peers': 'Bağlanan eş yok',
    'Failed to change some tasks state.': 'Görev Durumunu değiştirme başarısız.',
    'Confirm Retry': 'Yeniden Denemeyi Onayla',
    'Are you sure you want to retry the selected task? Negibox will create same task after clicking OK.': 'Seçilen görevi yeniden denemeyi onaylıyor musunuz? Negibox tamam a tıkladığınızda aynı görevi oluşturacak.',
    'Failed to retry this task.': 'Bu görevi yeniden denemede başarısızlık..',
    '{{successCount}} tasks have been retried and {{failedCount}} tasks are failed.': '{{successCount}} görev yeniden denendi ve {{failedCount}} görev başarısızlıkla sonuçlandı.',
    'Confirm Remove': 'Kaldırmayı Onayla',
    'Are you sure you want to remove the selected task?': 'Görevi kaldırmayı onaylıyor musunuz ?',
    'Failed to remove some task(s).': 'Görev(ler)i kaldırma başarısız',
    'Confirm Clear': 'Temizlemeyi Onayla',
    'Are you sure you want to clear stopped tasks?': 'Durmuş görevleri temizlemeyi onaylıyor musunuz ?',
    'Download Links:': 'İndirme Linkleri:',
    'Open Torrent File': 'Torrent Dosyası Aç',
    'Open Metalink File': 'Metalink Dosyası Aç',
    'Start Download': 'İndirme İşlemini Başlat',
    'Download Later': 'Sonra İndir',
    'Support multiple URLs, one URL per line.': 'Url adresi tek satırda olacak şekilde çoklu url desteği.',
    'Your browser does not support loading file!': 'Tarayıcınız dosya açmayı desteklemiyor!',
    'The selected file type is invalid!': 'Seçilen dosya türü geçersiz!',
    'Failed to load file!': 'Dosya açma başarısız!',
    'Download Completed': 'İndirme Tamamlandı',
    'BT Download Completed': 'BT İndirmesi Tamamlandı',
    ...
    'Page Title Refresh Interval': 'Sayfa Başlığı Yenileme Sıklığı',
    'Enable Browser Notification': 'Tarayıcı Bildirimlerini Aç',
    'Engine RPC Alias': 'Makine RPC Alias',
    'Engine RPC Address': 'Makine RPC Adresi',
    'Engine RPC Protocol': 'Makine RPC Protokolü',
    'Engine RPC Http Request Method': 'Makine RPC Http İstek Metodu',
    'POST method only supports aria2 v1.15.2 and above.': 'POST methody sadece aria2 v1.15.2 ve üstünde kullanabilir.',
    'Engine RPC Secret Token': 'Motor RPC Gizli Tokeni',
    'Activate': 'Aktifleştir',
    'Reset Settings': 'Ayarları Sıfırla',
    'Confirm Reset': 'Sıfırlamayı Onayla',
    'Are you sure you want to reset all settings?': 'Bütün ayarları sıfırlamayı onaylıyor musunuz ?',
    'Clear Settings History': 'Ayarlar Geçmişini Temizle',
    'Are you sure you want to clear all settings history?': 'Bütün ayarlar geçmişini temizlemeyi onaylıyor musunuz?',
    'Delete RPC Setting': 'RPC Ayarlarını Sİl',
    'Add New RPC Setting': 'Yeni RPC Ayarı Ekle',
    'Are you sure you want to remove rpc setting "{{rpcName}}"?': 'RPC ayarı "{{rpcName}}" silmeyi onaylıyor musunuz ?',
    'Global Stat Refresh Interval': 'Global Durum Yenileme Sıklığı',
    'Download Task Refresh Interval': 'İndirme Görevi Yenileme Sıklığı',
    'Action After Creating New Tasks': 'Görevi Oluşturduktan Sonra Yapılacak İş',
    'Removing Old Task After Retrying': 'Yeniden Denediktan Sonra Görevi Kaldırma',
    'Navigate to Task List Page': 'Görev Listesi Sayfasına Yönlendir',
    'Navigate to Task Detail Page': 'Görev Detayı Sayfasına Yönlendir',
    'Action After Retrying Task': 'Görevi Yeniden Denedikten Sonra Yapılacak İş',
    'Navigate to Downloading Task List Page': 'İndiliyor Olan Görev Listesi Sayfasına Yönlendir',
    'Stay on Current Page': 'Şu anki Sayfada Kal',
    'RPC List Display Order': 'RPC Listesi Görünme Düzeni',
    'Recently Used': 'Son Kullanılan',
    'RPC Alias': 'RPC Alias',
    'Import / Export Settings': 'Ayarları İçeri / Dışarı aktar',
    'Import Settings': 'Ayarları İçeri Aktar',
    'Export Settings': 'Ayarları Dışarı Aktar',
    'Settings data': 'Ayarlar verisi',
    'Confirm Import': 'İçeri Aktarmayı Onayla',
    'Are you sure you want to import all settings?': 'Bütün seçenekleri içeri aktarmayı onaylıyor musunuz ?',
    'Invalid settings data format!': 'Geçersiz ayarlar veri formatı!',
    'Data has been copied to clipboard.': 'Veri clipboard a kopyalandı.',
    'Supported Placeholder': 'Desteklenen Yertutucu',
    'Negibox Title': 'Negibox Başlığı',
    'Downloading Count': 'İndiriliyor olan Dosya Sayısı',
    'Waiting Count': 'Beklenen Dosya Sayısı',
    'Stopped Count': 'Durduruluşmuş Dosya Sayısı',
    'You have disabled notification in your browser. You should change your browser\'s settings before you enable this function.': 'Tarayıcınızdaki bildirimleri kapattınız.Bu özellikliği etkinleştirmek için tarayıcınızdaki bildirimleri açın.',
    'Configuration has been modified, please reload the page for the changes to take effect.': 'Konfigürasyon değiştirildi,Ayarların geçerli olması için sayfayı yenileyin.',
    'Reload Page': 'Sayfayı Yenile',
    'Show Secret': 'Secret i göster',
    'Hide Secret': 'Secret i gizle',
    'Engine Version': 'Motor Versiyonu',
    'Enabled Features': 'Özellikleri Etkinleştir',
    'Functions': 'Fonksiyonlar',
    'Save Session': 'Oturumu Kaydet',
    'Shutdown Engine': 'Motoru Kapat',
    'Confirm Shutdown': 'Kapatmayı Onayla',
    'Are you sure you want to shutdown aria2?': 'aria2 yi kapatmayı onaylıyor musunuz?',
    'Session has been saved successfully.': 'Oturum başarıyla kaydedildi.',
    'Engine has been shutdown successfully.': 'Motor başarıyla kapatıldı.',
    'Toggle Navigation': 'Navigasyon Panelini Aç/Kapa',
    'Quick Setting': 'Hızlı Ayarlar',
    'Global Speed Limit': 'Global Hız Limiti',
    'Loading': 'Yükleniyor...',
    'More Than One Day': '1 günden fazla',
    'Unknown': 'Bilinmeyen',
    'Bytes': 'Bytes',
    'Hours': 'Saatler',
    'Minutes': 'Dakikalar',
    ...
    'Http': 'Http',
    'Http (Disabled)': 'Http (Devre Dışı)',
    'Https': 'Https',
    'WebSocket': 'WebSocket',
    'WebSocket (Disabled)': 'WebSocket (Devre Dışı)',
    'WebSocket (Security)': 'WebSocket (Güvenlik)',
    'Http and WebSocket would be disabled when accessing Negibox via Https.': 'Negibox a https ile erişirken Http ve WebSocket devre dışı olmalı.',
    'POST': 'POST',
    'GET': 'GET',
    'Disabled': 'Devre Dışı',
    'BitTorrent': 'BitTorrent',
    'Changes to the settings take effect after refreshing page.': 'Değişiklerin uygulanması için sayfayı yenileyin.',
    'Latest {{count}} Logs': 'Son {{count}} Loglar',
    'Show Detail': 'Detay Göster',
    'Log Detail': 'Detayları Logla',
    'Type is illegal!': 'Tür geçersiz!',
    'Parameter is invalid!': 'Parametre geçersiz!',
    'Option value cannot be empty!': 'Değer seçeneği boş olamaz!',
    'Input number is invalid!': 'Giriş Sayısı Geçersiz!',
    'Input number is below min value!': 'Giriş sayısı minimum değerin altında {{value}}!',
    'Input number is above max value!': 'Giriş sayısı maximum değerin altında {{value}}!',
    'Input value is invalid!': 'Giriş Sayısı Geçerisz!',
    'Protocol is invalid!': 'Protokol Geçersiz!',
    'RPC host cannot be empty!': 'RPC host değeri boş olamaz!',
    'RPC secret is not base64 encoded!': 'RPC secret i base64 ile şifrelenmiş değil!',
    'URL is not base64 encoded!': 'URL base64 ile şifelenmiş değil!',
    'Tap to configure and get started with Negibox.': 'Konfigürasyon yapmak ve Negibox Kullanım Rehberi için tıklayın.',
    'Cannot initialize WebSocket!': 'WebSocket başlatılamadı!',
    'Access Denied!': 'Giriş Engellendi!',
    'You cannot use Negibox because this browser does not support data storage.': 'Negibox u kullanamazsınız çünkü tarayıcınız veri depolamayı desteklemiyor.',
    'error': {
    ...
    'format': {
        ...
        'settings.file-count': '({{count}} Files detail)',
