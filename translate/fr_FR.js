...
translations.fa_IR = {
    ...
    'Negibox Debug Console': 'Negibox Debug Console',
    ...
    'Are you sure you want to retry the selected task? Negibox will create same task after clicking OK.': 'Are you sure you want to retry the selected task? Negibox will create same task after clicking OK.',
    ...
    'Engine RPC Address': 'Engine RPC Address',
    'Engine RPC Protocol': 'Engine RPC Protocol',
    'Engine RPC Http Request Method': 'Engine RPC Http Request Method',
    'POST method only supports aria2 v1.15.2 and above.': 'POST method only supports aria2 v1.15.2 and above.',
    'Engine RPC Secret Token': 'Engine RPC Secret Token',
    'Activate': 'Activate',
    ...
    'Engine has been shutdown successfully.': 'Engine has been shutdown successfully.',
    ...
    'Http and WebSocket would be disabled when accessing Negibox via Https.': 'Http and WebSocket would be disabled when accessing Negibox via Https.',
    'POST': 'POST',
    'GET': 'GET',
    'Disabled': 'Disabled',
    ...
    'Tap to configure and get started with Negibox.': 'Tap to configure and get started with Negibox.',
    'Cannot initialize WebSocket!': 'Cannot initialize WebSocket!',
    'Access Denied!': 'Access Denied!',
    'You cannot use Negibox because this browser does not support data storage.': 'You cannot use Negibox because this browser does not support data storage.',
    'error': {
