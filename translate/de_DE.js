...
translations.de_DE = {
    'Operation Result': 'Ergebnis der Operation',
    'Operation Succeeded': 'Operation erfolgreich',
    '{{name}} is connected': '{{name}} ist verbunden',
    'Error': 'Fehler',
    'OK': 'OK',
    'Confirm': 'Bestätigen',
    'Cancel': 'Abbrechen',
    ...
    'Pause': 'Pausieren',
    'Retry': 'Wiederholen',
    'Retry Selected Tasks': 'Ausgewählte Aufgaben wiederholen',
    'Delete': 'Löschen',
    'Select All': 'Alle auswählen',
    'Select None': 'Nichts auswählen',
    'Select Invert': 'Auswahl invertieren',
    'Display Order': 'Auswahl Sortieren',
    'Copy Download Url': 'Download Link kopieren',
    'Help': 'Hilfe',
    'Search': 'Suche',
    'Default': 'Standard',
    'Expand': 'Expandieren',
    ...
    'Save': 'Speichern',
    'Import': 'Importieren',
    'Remove Task': 'Aufgabe entferenen',
    'Clear Stopped Tasks': 'Abgeschlossene Aufgaben entfernen',
    'Click to view task detail': 'Informationen zur Aufgabe anzeigen',
    'By File Name': 'Nach Dateinamen',
    'By File Size': 'Nach Dateigröße',
    'By Progress': 'Nach Fortschritt',
    'By Remain Time': 'Nach verbleibender Zeit',
    ...
    'Removed': 'Entfernt',
    'Finished / Stopped': 'Fertiggestellt / Gestoppt',
    'Uncompleted': 'Unvollständig',
    'Click to pin': 'Zum Anpinnen Anklicken',
    ...
    'Negibox Debug Console': 'Negibox Debug Konsole',
    'Engine Status': 'Engine Status',
    'File Name': 'Dateiname',
    'File Size': 'Dateigröße',
    'Progress': 'Fortschritt',
    'Share Ratio': 'Verteilungsrate',
    'Remain Time': 'Verbleibende Zeit',
    ...
    'Health Percentage': 'Gesundheitszustand',
    'Info Hash': 'Info Hash',
    'Seeders': 'Seeders',
    'Connections': 'Verbindungen',
    'Seed Creation Time': 'Seed Erschaffungszeit',
    ...
    'Other': 'Andere',
    'Custom': 'Eigenes',
    'Custom Choose File': 'Eigene Dateien aussuchen',
    'Address': 'Addresse',
    'Client': 'Client',
    'Status': 'Status',
    ...
    'Failed to change some tasks state.': 'Konnte einige Aufgabenzustände nicht ändern.',
    'Confirm Retry': 'Wiederholung bestätigen',
    'Are you sure you want to retry the selected task? Negibox will create same task after clicking OK.': 'Bist du sicher, dass du die ausgewählte Aufgabe wiederholen möchtest? Beim klicken auf OK erschafft Negibox die selbe Aufgabe erneut.',
    'Failed to retry this task.': 'Aufgabe konnten nicht erneut gestartet werden.',
    '{{successCount}} tasks have been retried and {{failedCount}} tasks are failed.': '{{successCount}} Aufgaben wurden erneut gestartet und {{failedCount}} Aufgaben sind gescheitert.',
    'Confirm Remove': 'Entfernen bestätigen',
    'Are you sure you want to remove the selected task?': 'Bist du sicher, dass du die ausgewählte Aufgabe abbrechen möchtest?',
    'Failed to remove some task(s).': 'Konnte Aufgabe(n) nicht abbrechen.',
    'Confirm Clear': 'Leeren bestätigen',
    'Are you sure you want to clear stopped tasks?': 'Bist du sicher, dass du alle beendeten Aufgaben entfernen möchtest?',
    'Download Links:': 'Download Links:',
    'Open Torrent File': 'Öffne Torrent-Datei',
    'Open Metalink File': 'Öffne Metalink-Datei',
    'Start Download': 'Starte Download',
    'Download Later': 'Später Herunterladen',
    'Support multiple URLs, one URL per line.': 'Mehrere URLs unterstützt, eine URL pro Zeile.',
    'Your browser does not support loading file!': 'Dein Browser unterstützt das Laden der Datei nicht!',
    'The selected file type is invalid!': 'Der ausgewählte Dateityp ist ungültig!',
    'Failed to load file!': 'Kann Datei nicht laden!',
    ...
    'Preview': 'Vorschau',
    'Tips: You can use the "noprefix" tag to ignore the prefix, "nosuffix" tag ignore the suffix, and "scale=n" tag to set the decimal precision.': 'Tipps: Du kannst den "noprefix" Tag zum Ignorieren des Prefix benutzen, der "nosuffix" Tag ignoriert den Suffix, und der "scale=n" Tag bestimmt die Dezimal-Genauigkeit.',
    'Example: ${downspeed:noprefix:nosuffix:scale=1}': 'Beispiel: ${downspeed:noprefix:nosuffix:scale=1}',
    'Page Title Refresh Interval': 'Seitentitel Neulade-Intervall',
    'Enable Browser Notification': 'Aktiviere Browser Notifikation',
    'Engine RPC Alias': 'Engine RPC Alias',
    'Engine RPC Address': 'Engine RPC Addresse',
    'Engine RPC Protocol': 'Engine RPC Protokoll',
    'Engine RPC Http Request Method': 'Engine RPC Http Anfragen Methode',
    'POST method only supports aria2 v1.15.2 and above.': 'POST Methode unterstützt nur aria2 v1.15.2 und höher.',
    'Engine RPC Secret Token': 'Engine RPC Geheimtoken',
    'Activate': 'Aktivieren',
    ...
    'Clear Settings History': 'Lösche die Einstellungs-Historie',
    'Are you sure you want to clear all settings history?': 'Bist du sicher, dass du die Einstellungs-Historie löschen willst?',
    'Delete RPC Setting': 'Lösche RPC Einstellungen',
    'Add New RPC Setting': 'Füge neue RPC Einstellungen hinzu',
    'Are you sure you want to remove rpc setting "{{rpcName}}"?': 'Bist du sicher, dass du die rpc Einstellung "{{rpcName}}" entfernen möchtest?',
    'Global Stat Refresh Interval': 'Globale Status Nachladeintervall',
    'Download Task Refresh Interval': 'Download Aufgaben Nachladeintervall',
    'Action After Creating New Tasks': 'Aktion nach Aufgabenerstellung',
    'Removing Old Task After Retrying': 'Entferne alte Aufgaben nach Wiederholung',
    'Navigate to Task List Page': 'Navigiere zu Aufgabenliste',
    'Navigate to Task Detail Page': 'Navigiere zu Aufgabenbeschreibung',
    'Action After Retrying Task': 'Aktion nach Wiederholung der Aufgabe',
    'Navigate to Downloading Task List Page': 'Navigiere zur Seite der Download Aufgabenliste',
    'Stay on Current Page': 'Auf momentaner Seite bleiben',
    'RPC List Display Order': 'RPC List Display Order',
    'Recently Used': 'Kürzlich benutzt',
    'RPC Alias': 'RPC Alias',
    'Import / Export Settings': 'Importieren / Exportieren der Einstellungen',
    'Import Settings': 'Einstellungen importieren',
    'Export Settings': 'Einstellungen exporteren',
    'Settings data': 'Einstellungsdaten',
    'Confirm Import': 'Importieren bestätigen',
    'Are you sure you want to import all settings?': 'Bist du sicher, dass du alle Einstellungen importieren willst?',
    'Invalid settings data format!': 'Ungültiges Dateiformat der Einstellungen!',
    'Data has been copied to clipboard.': 'Daten wurden in den Zwischenspeicher übertragen.',
    'Supported Placeholder': 'Unterstützte Platzhalter',
    'Negibox Title': 'Negibox Titel',
    'Downloading Count': 'Download Zähler',
    'Waiting Count': 'Auf Zähler warten',
    'Stopped Count': 'Zähler stoppen',
    ...
    'Show Secret': 'Geheimnisse anzeigen',
    'Hide Secret': 'Geheimnisse verstecken',
    'Engine Version': 'Engine Version',
    'Enabled Features': 'Aktivierte Funktionen',
    'Functions': 'Funktionen',
    'Save Session': 'Sitzung speichern',
    'Shutdown Engine': 'Engine herunterfahren',
    'Confirm Shutdown': 'Herunterfahren Bestätigen',
    'Are you sure you want to shutdown aria2?': 'Bist du sicher, dass du Aria 2 herunterfahren willst?',
    'Session has been saved successfully.': 'Sitzung wurde erfolgreich gespeichert.',
    'Engine has been shutdown successfully.': 'Engine wurde erfolgreich heruntergefahren.',
    'Toggle Navigation': 'Navigation umschalten',
    'Quick Setting': 'Schnelleinstellungen',
    'Global Speed Limit': 'Globales Geschwindigkeitslimit',
    'Loading': 'Lade...',
    'More Than One Day': 'Mehr als ein Tag',
    'Unknown': 'Unbekannt',
    'Bytes': 'Bytes',
    'Hours': 'Stunden',
    'Minutes': 'Minuten',
    ...
    'Http and WebSocket would be disabled when accessing Negibox via Https.': 'Http und WebSocket werden durch Verbinden mit Negibox über Https deaktiviert.',
    'POST': 'POST',
    'GET': 'GET',
    'Disabled': 'Deaktiviert',
    'BitTorrent': 'BitTorrent',
    'Changes to the settings take effect after refreshing page.': 'Änderungen an diesen Werten werden erst nach Aktualisierung der Seite angewendet.',
    'Latest {{count}} Logs': 'Letzte {{count}} Protokolle',
    'Show Detail': 'Details anzeigen',
    'Log Detail': 'Details Protokollieren',
    'Type is illegal!': 'Typ ist illegal!',
    'Parameter is invalid!': 'Parameter ist ungültig!',
    'Option value cannot be empty!': 'Optionsparameter kann nicht leer sein!',
    'Input number is invalid!': 'Eingabenummer ist ungültig!',
    'Input number is below min value!': 'Eingabenummer liegt unter der minimalen Anzahl {{value}}!',
    'Input number is above max value!': 'Eingabenummer liegt über der maximalen Anzahl {{value}}!',
    'Input value is invalid!': 'Eingabewerte sind ungültig!',
    'Protocol is invalid!': 'Protokoll ist ungültig!',
    'RPC host cannot be empty!': 'RPC host kann nicht leer sein!',
    'RPC secret is not base64 encoded!': 'RPC Geheimniss ist nicht base64 kodiert!',
    'URL is not base64 encoded!': 'URL ist nicht base64 kodiert!',
    'Tap to configure and get started with Negibox.': 'Zum Konfigurieren und Starten von Negibox anklicken.',
    'Cannot initialize WebSocket!': 'Kann WebSocket nicht starten!',
    'Access Denied!': 'Zutritt verweigert!',
    'You cannot use Negibox because this browser does not support data storage.': 'Du kannst Negibox nicht benutzen da dieser Browser Dateispeicherung nicht unterstützt',
    'error': {
        'unknown': 'Unbekannter Fehler aufgetreten.',
        'operation.timeout': 'Zeitüberschreitung bei der Operation.',
        'resource.notfound': 'Ressource nicht gefunden.',
        'error.resource.notfound.max-file-not-found': 'Resource nicht gefunden. Siehe --max-file-not-found Option.',
        'error.download.aborted.lowest-speed-limit': 'Download wurde abbgebrochen weil Downloadgeschwindigkeit zu niedrig war. Siehe --lowest-speed-limit Option.',
        'network.problem': 'Netzwerkproblem aufgetreten.',
        'resume.notsupported': 'Remote-Server unterstützt keine Wiederaufnahme.',
        'space.notenough': 'Es gibt nicht genug freien Speicherplatz auf der Festplatte.',
        'piece.length.different': 'Stücklänge unterscheidet sich von Länge in .aria2 Kontrolldatei. Siehe --allow-piece-length-change Option.',
        'download.sametime': 'aria2 lädt diese Datei bereits herunter.',
        'download.torrent.sametime': 'aria2 lädt diese Datei bereits herunter.',
        'file.exists': 'Datei existiert bereits. Siehe --allow-overwrite Option.',
        'file.rename.failed': 'Konnte Datei nicht umbenennen. Siehe --auto-file-renaming Option.',
        'file.open.failed': 'Konnte existierende Datei nicht öffnen.',
        'file.create.failed': 'Konnte neue Datei nicht erschaffen oder existierende Datei nicht kürzen.',
        'io.error': 'Dateisystemfehler aufgetreten.',
        'directory.create.failed': 'Konnte Verzeichnis nicht erschaffen.',
        'name.resolution.failed': 'Konnte Domainen-Name nicht auflösen.',
        'metalink.file.parse.failed': 'Konnte Metalink-Dokument nicht parsen.',
        ...
        'option.bad': 'Falche/unbekannte Option wurde übergeben oder ein unerwartetes Optionsargument wurde übergeben.',
        'server.overload': 'Der Remote-Server war aufgrund einer temporären Überlastung oder Wartung unfähig die Anfrage zu behandeln.',
        'rpc.request.parse.failed': 'JSON-RPC Anfrage konnte nicht geparst werden.',
        'checksum.failed': 'Checksum Überprüfung gescheitert.'
    },
    'format': {
        ...
        'task.pieceinfo': 'Fertiggestellt: {{completed}}, Total: {{total}}',
        'task.error-occurred': 'Fehler aufgetreten ({{errorcode}})',
        'settings.file-count': '({{count}} Dateieigenschaften)',
        'settings.total-count': '(Gesamtzahl: {{count}})',
    ...
    'options': {
        ...
        'allow-overwrite.name': 'Erlaube das Überschreiben',
        ...
        'always-resume.name': 'Download immer fortfahren',
        ...
        'enable-color.name': 'Farbe im Terminal aktivieren',
        ...
        'force-save.name': 'Erzwinge speichern',
        ...
        'save-not-found.name': 'Speicherdatei nicht gefunden',
        ...
        'hash-check-only.name': 'Nur Hash Überprüfung ',
        ...
        'human-readable.name': 'Menschlich lesbare Konsolenausgabe',
        ...
        'show-console-readout.name': 'Zeige Konsolenausgabe',
        ...
        'max-overall-download-limit.name': 'Setze globales Maximales Download Limit',
        ...
        'max-download-limit.name': 'Setze Maximales Download Limit',
        ...
        'no-conf.name': 'Entferne Konfigurationsdatei',
        'no-conf.description': '',
        ...
        'realtime-chunk-checksum.description': 'Überprüfe Dateiteile während eines Downloads unter Benutzung von Checksums, sofern Dateiteilüberprüfung angeboten wird.',
        'remove-control-file.name': 'Entferne Kontrolldatei',
        'remove-control-file.description': 'Entferne Kontrolldatei vor dem Download. Unter nutzen von --allow-overwrite=true werden Downloads stehts komplett neugestartet. Dies kann für Nutzer hilfreich sein, die sich hinter einem Proxy Server befinden, welcher das Wiederaufnehmen von Downloads verhindert.',
        'save-session.name': 'Session Save File',
        'save-session.description': 'Speichere gescheiterte/unfertige Downloads beim Beenden in eine Datei. Du kannst diese Ausgabedatei beim Neustart mittels --input-file an Aria2c übergeben. Falls du die Ausgabe als .gzip komprimieren möchtest, füge ein .gz zum Dateinamen hinzu. Bitte bedenke dass Downloads hinzugefügt mittels aria2.addTorrent() und der aria2.addMetalink() RPC Methode und deren Metadaten nicht in eine Datei übertragen werden konnten nicht gespeichert werden. Downloads, die mittels aria2.remove() und aria2.forceRemove() entfernt wurden werden auch nicht gespeichert.',
        'save-session-interval.name': 'Speichere "Session Interval"',
        'save-session-interval.description': 'Speichere gescheiterte/unfertige Downloads alle SEC Sekunden in eine Datei spezifiert mittels der --save-session Option. Der Wert 0 speichert die Datei nur beim Beenden von Aria2.',
        'socket-recv-buffer-size.name': 'Socket Empfangsbuffergröße',
        'socket-recv-buffer-size.description': 'Setze den Socket Empfangsbuffer in Bytes. Der Wert 0 Deaktiviert dieses Feature. Der Wert wird in den Socket Dateibeschreiber mittels SO_RCVBUF unter nutzen des setsockop() Aufruf gesetzt.',
        'stop.name': 'Automatisches Herunterfahren',
        'stop.description': 'Beende Programm nach SEC Sekunden. Der Wert 0 Deaktiviert dieses Feature',
        'truncate-console-readout.name': 'Kürze Konsolenausgabe',
        'truncate-console-readout.description': 'Kürze Konsolenausgabe,  um in eine einzige Zeile zu passen.'
    }
};
